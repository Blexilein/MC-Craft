...
const translations = {
    ...
    en: {
        site_title_color: "MC-Craft | Color Text Converter",
        site_title_short: "MC-Craft",
        nav_home: "Home",
        ...
        sound_toggle: "Sound",
        language: "Language",
        color_hero_title: "Minecraft <span class=\"highlight\">Color Text</span> Converter",
        hero_badge: "V 1.0.0 is here",
        color_hero_desc: "Create colored and formatted texts for Minecraft with simple clicks. Perfect for your server MOTDs, signs, chat messages and more.",
        color_hero_btn_converter: "Go to Converter",
        color_hero_btn_text: "Text Converter",
        color_grid_colors: "16 Colors",
        color_grid_formats: "6 Formats",
        color_grid_preview: "Live Preview",
        color_grid_symbols: "40+ Symbols",
        color_section_title: "Color Text <span class=\"highlight\">Converter</span>",
        color_section_subtitle: "Choose colors and formats for your Minecraft text",
        color_colors_title: "Colors",
        color_formats_title: "Formats",
        color_label_text: "Your Text",
        color_placeholder_text: "Enter your text here...",
        color_char_count: "characters",
        color_btn_apply: "Apply Formatting",
        color_btn_clear: "Clear All",
        color_btn_example: "Insert Example",
        color_label_preview: "Live Preview",
        color_preview_placeholder: "Your preview appears here...",
        color_btn_copy_formatted: "Copy Formatted Text",
        color_btn_copy_codes: "Copy Color Codes (&)",
        color_btn_copy_minecraft: "Copy Minecraft Codes (§)",
        banner_style: "Banner Style",
        banner_none: "No Banner",
        color_symbols_title: "Special",
        color_symbols_highlight: "Symbols",
        color_symbols_subtitle: "Symbols for your Minecraft texts",
        color_filter_all: "All",
        color_filter_smileys: "😊 Smileys",
        color_filter_people: "👤 People",
        color_filter_animals: "🐶 Animals",
        color_filter_food: "🍕 Food",
        color_filter_activity: "⚽ Activities",
        color_filter_travel: "✈️ Travel",
        color_filter_objects: "📱 Objects",
        color_filter_symbols: "❤️ Symbols",
        color_filter_flags: "🏳️ Flags",
        color_filter_decorative: "♣ Decorative",
        color_filter_arrows: "↔ Arrows",
        color_filter_shapes: "❖ Shapes",
        color_filter_special: "⚒ Special",
        color_tips_title: "Formatting Explained",
        color_tip_obfuscated_title: "Obfuscated (&k)",
        color_tip_obfuscated_desc: "Text appears animated with random characters in Minecraft",
        color_tip_reset_title: "Reset (&r)",
        color_tip_reset_desc: "Resets all formatting to default",
        color_tip_combine_title: "Combinations",
        color_tip_combine_desc: "Combine colors and formats for cool effects",
        color_tip_compat_title: "Compatibility",
        color_tip_compat_desc: "Works in chat, signs, books and server MOTDs",
        color_examples_title: "Quick",
        color_examples_highlight: "Examples",
        color_examples_subtitle: "Click on an example to load it into the converter",
        color_example_welcome_title: "Welcome Message",
        color_example_welcome_desc: "Perfect for server MOTDs",
        color_example_warning_title: "Warning",
        color_example_warning_desc: "Highlight important rules",
        color_example_rainbow_title: "Rainbow Text",
        color_example_rainbow_desc: "Colored text for each letter",
        color_example_secret_title: "Secret Message",
        color_example_secret_desc: "With obfuscated effect",
        color_cta_title: "Discover more Minecraft <span class=\"highlight\">Tools</span>?",
        color_cta_desc: "MC-Craft offers many more useful tools for your Minecraft adventure.",
        color_cta_btn_text: "Text Converter",
        color_cta_btn_all: "View all tools",
        ...
        footer_version: "Version 1.0.0",
        footer_changelog: "Changelog",
        toast_welcome_title: "Color Text Converter loaded!",
        toast_welcome_message: "Create colored Minecraft texts now!",
        toast_sound_title: "Sound",
        ...
        toast_apply_title: "Formatting applied",
        toast_apply_message: "Text has been formatted successfully",
        toast_clear_title: "All cleared",
        toast_clear_message: "All texts have been cleared",
        toast_example_title: "Example inserted",
        toast_example_message: "An example text has been loaded",
        toast_example_loaded: "Example loaded",
        toast_example_loaded_message: "Example text has been inserted",
        toast_error_title: "Error",
        toast_error_no_text: "No text to copy",
        toast_copy_title: "Text copied",
        toast_copy_formatted: "Formatted text has been copied",
        toast_copy_codes: "Color codes (&) have been copied",
        toast_copy_minecraft: "Minecraft color codes (§) have been copied",
        toast_symbol_insert: "Symbol inserted",
        toast_symbol_copy: "Symbol copied",
        toast_symbol_copy_message: "has been copied",
        toast_symbol_insert_message: "has been inserted",
        symbol_insert_title: "Insert symbol",
        symbol_copy_title: "Copy symbol",
        toast_error_message: "A small error occurred. The page will continue to work.",
        ...
        color_motd_title: "MOTD Server Preview",
        color_motd_subtitle: "This is how your text looks in common server configs",
        color_motd_center_lines: "Center lines",
        color_motd_live_preview: "Live Server Preview",
        color_motd_live_preview_je: "Live Server Preview (JE)",
        color_motd_live_preview_be: "Live Server Preview (BE)",
        color_motd_live_note: "Minecraft may render the MOTD slightly differently. Test it on your server.",
        color_motd_vanilla_label: "For official/vanilla server.properties file:",
        color_motd_spigot_label: "For Spigot server.properties file:",
        color_motd_bungee_label: "For BungeeCord config.yml file:",
        color_motd_serverlistplus_label: "For ServerListPlus serverListPlus.yml file:",
        color_motd_bedrock_label: "For Bedrock server.properties file (motd):",
        color_reference_title: "Color Code Reference (JE + BE)",
        color_reference_subtitle: "List with code, name, HEX and version from the Minecraft color code table",
        color_reference_code: "Code",
        color_reference_name: "Name",
        color_reference_fg_hex: "FG Hex",
        color_reference_bg_hex: "BG Hex",
        color_reference_ansi: "ANSI",
        color_reference_version: "Version",
        color_reference_note: "Note",
        color_reference_conflict: "Code conflict with JE format",
        motd_copy_btn: "Copy",
        color_edition_switch_label: "Select Edition",
        color_edition_je: "JE",
        color_edition_be: "BE",
        color_badge_je: "JE",
        color_badge_be: "BE",
        color_badge_both: "JE+BE",
        color_conflict_note: "(Java: format code)",
        loader_text1_color: "Color Text Converter is loading...",
        loader_text2: "Loading color palette...",
        loader_text3: "Preparing symbols...",
        loader_text4: "Initializing sound system...",
...
function getCurrentExampleTexts() {
    return exampleTexts[currentLang] || exampleTexts.de;
}
...
function getEditionLabel(edition) {
    if (edition === 'je') return getTranslation('color_badge_je');
    if (edition === 'be') return getTranslation('color_badge_be');
    return getTranslation('color_badge_both');
}
...
function populateBannerSelect() {
    ...
    bannerTemplates.forEach((b, index) => {
        ...
        option.value = index;
        option.textContent = index === 0 ? getTranslation('banner_none') : getBannerLabel(b);
...
function updateLanguage() {
    ...
    // Seitentitel
    document.title = getTranslation('site_title_color');
}
...
function initLoader() {
    ...
    const texts = [
        getTranslation('loader_text1_color'),
...
function loadColors() {
    ...
    minecraftColors.forEach(color => {
        ...
        const conflictNote = color.conflict ? ` ${getTranslation('color_conflict_note')}` : '';
...
function updatePreview() {
    ...
    if (!text.trim()) {
        preview.textContent = getTranslation('color_preview_placeholder');
        updateMotdOutputs();
        return;
    }
...
function applyFormatting() {
    updatePreview();
    showToast(
        getTranslation('toast_apply_title'),
        getTranslation('toast_apply_message'),
        'success'
    );
    playClickSound();
}
...
function clearAll() {
    ...
    textInput.focus();
    showToast(
        getTranslation('toast_clear_title'),
        getTranslation('toast_clear_message'),
        'info'
    );
    playClickSound();
}
...
function insertExample() {
    ...
    updateCharCount();
    showToast(
        getTranslation('toast_example_title'),
        getTranslation('toast_example_message'),
        'info'
    );
    playClickSound();
}
...
function copyFormatted() {
    ...
    if (!text.trim()) {
        showToast(
            ...
            getTranslation('toast_error_no_text'),
            'error'
        );
        return;
    }
    ...
    showToast(
        getTranslation('toast_copy_title'),
        getTranslation('toast_copy_formatted'),
        'success'
    );
...
function copyCodes() {
    ...
    showToast(
        getTranslation('toast_copy_title'),
        getTranslation('toast_copy_codes'),
        'success'
    );
...
function copyMinecraftCodes() {
    ...
    showToast(
        getTranslation('toast_copy_title'),
        getTranslation('toast_copy_minecraft'),
        'success'
    );
...
function initMotdCopyButtons() {
    document.querySelectorAll('.motd-copy-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            if (!value.trim()) {
                showToast(getTranslation('toast_error_title'), getTranslation('toast_error_no_text'), 'error');
                return;
            }
            copyToClipboard(value);
            showToast(getTranslation('toast_copy_title'), getTranslation('toast_copy_codes'), 'success');
            highlightButton(btn);
        });
    });
}
    ...
    symbolsData.forEach(symbol => {
        ...
        symbolElement.innerHTML = `
            ...
            <div class="symbol-action">
                <button class="symbol-insert-btn" title="${getTranslation('symbol_insert_title')}"><i class="fas fa-plus"></i></button>
                <button class="symbol-copy-btn" title="${getTranslation('symbol_copy_title')}"><i class="fas fa-copy"></i></button>
            </div>
        `;
        ...
        insertBtn.addEventListener('click', (e) => {
            ...
            showToast(
                getTranslation('toast_symbol_insert'),
                `${symbol.name} ${getTranslation('toast_symbol_insert_message') || 'wurde eingefügt'}`,
                'info'
            );
        });
        ...
        copyBtn.addEventListener('click', (e) => {
            ...
            showToast(
                getTranslation('toast_symbol_copy'),
                `${symbol.char} ${getTranslation('toast_symbol_copy_message') || 'wurde kopiert'}`,
                'success'
            );
        });
...
function updateMotdOutputs() {
    ...
    if (!sourceText.trim()) {
        motdLivePreviewJe.textContent = getTranslation('color_preview_placeholder');
        motdLivePreviewBe.textContent = getTranslation('color_preview_placeholder');
...
function renderColorReferenceList() {
    ...
    minecraftColors.forEach(color => {
        ...
        const note = color.conflict ? getTranslation('color_reference_conflict') : '-';
    ...
    exampleCards.forEach(card => {
        card.addEventListener('click', function() {
            ...
            if (exampleText) {
                ...
                updateCharCount();
                showToast(
                    getTranslation('toast_example_loaded'),
                    getTranslation('toast_example_loaded_message'),
                    'info'
                );
                playClickSound();
...
window.addEventListener('error', function(e) {
    ...
    showToast(
        getTranslation('toast_error_title'),
        getTranslation('toast_error_message') || 'Ein kleiner Fehler ist aufgetreten. Die Seite funktioniert weiterhin.',
        'error'
    );
});
