...
// Übersetzungen – alle für die About-Seite benötigten Schlüssel (inkl. Toast-Texte)
const translations = {
    de: {
        // Allgemein
        ...
        about_feature5_title: "Open Source",
        about_feature5_desc: "Viele unserer Tools sind Open Source und können auf GitHub eingesehen und verbessert werden.",
    ...
    en: {
        ...
        about_feature5_title: "Open Source",
        about_feature5_desc: "Many of our tools are open source and can be viewed and improved on GitHub.",
...
function updateLanguage() {
    ...
    // Seitentitel
    document.title = getTranslation('site_title_about');
}
...
function initLoader() {
    ...
    const texts = [
        getTranslation('loader_text1_about'),
