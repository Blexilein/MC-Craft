...
const translations = {
    de: {
        ...
        copyright_card2_line1: "<strong>Copyright © 2026 MC-Craft.</strong> Alle Rechte vorbehalten.",
        copyright_card2_line2: "Die Inhalte dieser Webseite sind urheberrechtlich geschützt. Eine Nutzung, Vervielfältigung oder Veränderung ist nur mit ausdrücklicher schriftlicher Genehmigung des Rechteinhabers erlaubt.",
        copyright_card2_line3: "Nicht offiziell mit Mojang oder Microsoft verbunden.",
    ...
    en: {
        ...
        copyright_card2_line1: "<strong>Copyright © 2026 MC-Craft.</strong> All rights reserved.",
        copyright_card2_line2: "The contents of this website are protected by copyright. Use, reproduction or modification is only permitted with the express written permission of the rights holder.",
        copyright_card2_line3: "Not officially affiliated with Mojang or Microsoft.",
...
function updateLanguage() {
    ...
    // Seitentitel
    document.title = getTranslation('site_title_copyright');
}
...
function initLoader() {
    ...
    const texts = [
        getTranslation('loader_text1_copyright'),
