...
function getCurrentExampleTexts() {
    return exampleTexts.en || exampleTexts.de;
}
    ...
    symbolsData.forEach(symbol => {
        ...
        insertBtn.addEventListener('click', (e) => {
            ...
            showToast(
                ...
                `${symbol.name} ${t('toast_symbol_insert_message') || 'has been inserted'}`,
                'info'
            );
        });
        ...
        copyBtn.addEventListener('click', (e) => {
            ...
            showToast(
                t('toast_symbol_copy'),
                `${symbol.char} ${t('toast_symbol_copy_message') || 'has been copied'}`,
                'success'
            );
        });
...
function initPageAnalytics() {
    console.log('MC-Craft Color Text Converter loaded');
...
document.addEventListener('keydown', (e) => {
    // Page shortcut only - Escape/theme handling lives in main.js.
