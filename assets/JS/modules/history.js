...
// Übersetzungen – alle für die Geschichte-Seite benötigten Schlüssel (inkl. Toast-Texte)
const translations = {
    de: {
        // Allgemein
...
function updateLanguage() {
    ...
    // Seitentitel
    document.title = getTranslation('site_title_history');
}
...
function initLoader() {
    ...
    const texts = [
        getTranslation('loader_text1_history'),
