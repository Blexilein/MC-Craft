...
const I18N = {
    de: {
        ...
        loader_text: "Advancement Generator wird geladen...",
        loader_text2: "Icons werden vorbereitet...",
        ...
        hero_title: "DEIN <span class=\"highlight\">ADVANCEMENT</span> GENERATOR",
        hero_desc: "Baue eigene Achievement- und Advancement-Bilder mit zwei Textzeilen, Icon und freien Farben. Direkt als PNG für Thumbnails, Discord und Overlays.",
        hero_btn: "Zum Generator",
        hero_btn_tools: "Alle Tools",
        hero_grid_frames: "4 RAHMEN",
        hero_grid_export: "PNG EXPORT",
        hero_grid_lines: "2 TEXTZEILEN",
        hero_grid_colors: "FREIE FARBEN",
        settings_title: "Einstellungen",
        frame_label: "Rahmen-Typ",
        frame_achievement: "Achievement Get!",
        frame_achievement_hint: "Vor 1.12, gelb",
        frame_advancement: "Advancement Made!",
        frame_advancement_hint: "Ab 1.12, grün",
        frame_challenge: "Challenge Complete!",
        frame_challenge_hint: "Lila",
        frame_goal: "Goal Reached!",
        frame_goal_hint: "Ziel, gelb",
        line1_label: "Zeile 1 (Überschrift)",
        line1_placeholder: "Advancement Made!",
        line2_label: "Zeile 2 (Unterschrift, weiß)",
        line2_placeholder: "Getting an Upgrade",
        line3_toggle: "3. Zeile anzeigen",
        line4_toggle: "4. Zeile anzeigen",
        line3_label: "Zeile 3 (optional)",
        line4_label: "Zeile 4 (optional)",
        line3_placeholder: "mc-craft.com",
        line4_placeholder: "mc-craft.com",
        style_label: "Box-Stil",
        color_line3: "Zeile 3",
        color_line4: "Zeile 4",
        chars_hint: "Zeichen",
        icon_label: "Icon",
        icon_search_placeholder: "Item, Block, Mob, Herz oder Dialog-Icon suchen...",
        icon_group_heart: "Herz",
        icon_group_dialog: "Dialog",
        icon_tab_all: "Alle",
        icon_tab_items: "Items",
        icon_tab_mobs: "Mobs",
        icon_tab_hearts: "Herzen",
        icon_tab_dialogs: "Dialoge",
        mob_variant_face: "Gesicht",
        mob_variant_body: "Körper",
        icon_loading: "Icons werden geladen...",
        icon_empty: "Nichts gefunden. Nutze ein eigenes Bild oder eine Bild-URL.",
        icon_failed: "Icon-Datenbank nicht erreichbar. Nutze ein eigenes Bild oder eine Bild-URL.",
        icon_upload: "Eigenes Bild",
        icon_url: "Bild-URL",
        icon_clear: "Kein Icon",
        icon_url_prompt: "Bild-URL einfügen (PNG empfohlen):",
        custom_colors_toggle: "Eigene Farben nutzen",
        color_line1: "Zeile 1",
        color_line2: "Zeile 2",
        color_fill: "Box-Füllung",
        color_border: "Box-Rahmen",
        color_outline: "Außenlinie",
        color_bg_a: "Hintergrund",
        color_bg_b: "Verlauf-Farbe",
        btn_reset_colors: "Farben zurücksetzen",
        bg_label: "Bild-Hintergrund",
        bg_transparent: "Transparent",
        bg_solid: "Einfarbig",
        bg_gradient: "Verlauf",
        scale_label: "Auflösung",
        width_label: "Box-Breite",
        width_fixed: "Fest (200 px)",
        width_vanilla: "Vanilla (160 px)",
        width_auto: "Automatisch",
        padding_label: "Rand um die Box",
        caption_rendered: "Gerendert in {scale}x Pixel-Skalierung ({width}x{height} PNG) - passt für Thumbnails, Discord und Overlays.",
        shadow_toggle: "Textschatten wie in Minecraft",
        preset_upgrade: "Getting an Upgrade",
        preset_welcome: "Willkommen!",
        btn_download: "PNG herunterladen",
        btn_copy: "Bild kopieren",
        preview_title: "Vorschau",
        preview_size: "Bildgröße",
        preview_hint: "Tipp: Die Box wächst automatisch mit deinem Text mit. Für Thumbnails 4x oder 8x nehmen.",
        ...
        skins_library_title: "Skin Galerie",
        capes_db_title: "Cape Galerie",
        toast_loaded_title: "Bereit",
        toast_loaded_message: "Advancement Generator geladen.",
        toast_theme_title: "Theme",
        toast_theme_to: "Theme gewechselt zu {theme}.",
        toast_sound_title: "Sound",
        toast_sound_on: "Sound ist an.",
        toast_sound_off: "Sound ist aus.",
        toast_language_title: "Sprache",
        toast_language_de: "Sprache auf Deutsch gestellt.",
        toast_language_en: "Sprache auf Englisch gestellt.",
        toast_downloaded: "PNG gespeichert.",
        toast_copied: "Bild in die Zwischenablage kopiert.",
        toast_copy_failed: "Kopieren hat nicht geklappt. Nutze den Download.",
        toast_export_failed: "Externes Icon blockiert den Export. Lade das Bild stattdessen hoch.",
...
function renderIconSubTabs() {
    ...
    list.forEach((sub) => {
        ...
        btn.textContent = `${sub[lang] || sub.de} (${count})`;
...
function renderStyleGrid() {
    ...
    boxStyles.forEach((style) => {
        ...
        button.title = style.name[lang] || style.name.de;
